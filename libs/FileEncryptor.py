...
import time
import binascii
# python FileEncryptor.py -p asdfqwer#@! -e shexiangfuren.mp3
# python FileEncryptor.py -p asdfqwer#@! -d shexiangfuren.mp3.enc
...
class FileEncryptor(object):
    ...
    def decrypt(cipher_text, key):
        ...
        print(binascii.hexlify(iv), 2023)
        cipher = AES.new(key, AES.MODE_CBC, iv)
...
if __name__ == '__main__':
    ...
    # FE.handle()
    pwd = 'asdfqwer#@!'
    FileEncryptor().get_key(pwd)
    FileEncryptor().encrypt_file('shexiangfuren.mp3')
    #FileEncryptor().decrypt_file('shexiangfuren.mp3.enc')
